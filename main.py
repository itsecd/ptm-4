...
class Library:
    ...
    def add_person(self, person: Person) -> None:
        ...
        self.logger.info(f"Добавлена персона: {person}")
    ...
    def remove_person(self, person: Person) -> None:
        ...
        if person in self.people:
            ...
            self.logger.info(f"Персона удалена: {person}")
        else:
            self.logger.warning(f"Попытка удалить несуществующую персону: {person}")
    ...
    def add_book(self, book: Book) -> None:
        ...
        self.logger.info(f"Добавлена книга: {book}")
    ...
    def remove_book(self, book: Book) -> None:
        ...
        if book in self.books:
            ...
            self.logger.info(f"Книга удалена: {book}")
        else:
            self.logger.warning(f"Попытка удалить несуществующую книгу: {book}")
    ...
    def lend_book(self, book: Book, person: Person) -> None:
        ...
        if book in self.books and person in self.people:
            ...
            self.logger.info(f"{person} взял в аренду книгу: {book}")
        else:
            self.logger.warning(f"Невозможно выдать книгу {book} в аренду {person}")
    ...
    def display_books(self) -> None:
        ...
        :return: None
        """
        self.logger.info("Вывод информации о книгах:")
    ...
    def save_to_txt(self, filename: str = 'library.txt') -> None:
        ...
        try:
            ...
            self.logger.info(f"Данные о библиотеке сохранены в файл: {filename}")
        except Exception as e:
            self.logger.warning(f"Ошибка при сохранении данных о библиотеке в файл {filename}: {str(e)}")
    ...
    def load_from_txt(self, filename: str = 'library.txt') -> None:
        ...
        try:
            ...
            self.logger.info(f"Данные о библиотеке загружены из файла: {filename}")
        except FileNotFoundError:
            self.logger.warning(f"Файл {filename} не найден.")
        except Exception as e:
            self.logger.warning(f"Ошибка при загрузке данных о библиотеке из файла {filename}: {str(e)}")
